...
describe('DBOSClient', () => {
  ...
  // The public caller-owned transaction API explicitly requires a pg ClientBase.
  // These tests exercise PostgreSQL transaction visibility and aborted-transaction semantics.
